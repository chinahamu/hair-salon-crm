...
export default function Edit({ auth, menu, products, roomTypes, machines, roles, medicines, consumables, menuItems }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        campaign_flag: menu.campaign_flag || false,
        publish_start_at: menu.publish_start_at ? menu.publish_start_at.replace(' ', 'T').slice(0, 16) : '',
        publish_end_at: menu.publish_end_at ? menu.publish_end_at.replace(' ', 'T').slice(0, 16) : '',
